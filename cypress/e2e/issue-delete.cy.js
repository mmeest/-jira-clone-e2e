...
describe('Issue create', () => {
  ...
  it('Should delete first issue and validate deletion', () => {
    ...
    cy.get('[data-testid="modal:issue-details"] textarea').should('contain.text', 'This is an issue of type: Task.');
    ...
    cy.get('[data-testid="modal:issue-details"] textarea').should('not.contain.text', 'This is an issue of type: Task.');
  });
  ...
  it('Should cancel deleteion ot the first issue and validate issue remains', () => {
    ...
    cy.reload();
    cy.get('[data-testid="modal:issue-details"] textarea').should('have.value', 'This is an issue of type: Task.');   
  });  
});